...
public class InitialDialog extends JDialog {
	...
	public InitialDialog(Frame owner) {
		...
		stoneLabel.setFont(new Font("Monospaced", Font.BOLD, 15));
		JRadioButton three = new JRadioButton("3", true);	// set to default pressed
		three.setFont(new Font("Monospaced", Font.PLAIN, 15));
		JRadioButton four = new JRadioButton("4");
		four.setFont(new Font("Monospaced", Font.PLAIN, 15));
		...
		JLabel layoutLabel = new JLabel("Choose your layout:");
		layoutLabel.setFont(new Font("Monospaced", Font.BOLD, 15));
		JRadioButton defaultButton = new JRadioButton("Default", true);	// set to default pressed
		defaultButton.setFont(new Font("Monospaced", Font.PLAIN, 15));
		JRadioButton fancyButton = new JRadioButton("Fancy");
		fancyButton.setFont(new Font("Monospaced", Font.PLAIN, 15));
