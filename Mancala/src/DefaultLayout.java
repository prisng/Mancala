...
public class DefaultLayout extends MyLayout {
	...
	public DefaultLayout() {
		try {
			...
			this.setBackground(ImageIO.read(new File("default_background.png"))); // default background
			this.setStone(ImageIO.read(new File("mancala_stone.png")));	// green stones
		} catch (IOException e) {
			setBackground(null);
		}
	}
