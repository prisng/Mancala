...
public class MancalaModel {
	...
	/**
	 * Ends the Mancala game.
	 * @param side	the next player's side
	 */
	...
	/**
	 * Keeps track of the pits.
	 * @param pit	the selected pit
	 * @return		the next pit after the selected pit
	 */
	...
	/**
	 * Displays the current player of the game.
	 * @return	a string saying whose turn it is
	 */
	...
	/**
	 * Get the number of undos for the current player.
	 * @return	the number of undos left for the current player
	 */
